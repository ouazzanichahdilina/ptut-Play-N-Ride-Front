...
const exercises = [
  ...
  { id: 5, title: "L'Ascension Alpine", objective: "Cardio", desc: "Défi stimulant en montagne pour faire travailler votre cœur.", duration: "25 min", intensity: "Élevée", image: "/images/scen-montagne.png", color: "#0284C7" },
