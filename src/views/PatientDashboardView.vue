...
const startGame = () => {
  ...
  // On ne passe plus l'avatar en query puisqu'il est dans le système (localStorage), 
  // le jeu l'y récupèrera directement.
  router.push({ 
    path: '/play', 
    query: { theme: selectedActivity.value.theme, equip: selectedEquip.value, from: 'patient' } 
  })
}
</script>
